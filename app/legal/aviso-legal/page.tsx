  ...
  return (
    <LegalPage title="Aviso legal" updatedAt="Mayo 2026">
      <LegalSection title="Titular del servicio">
        <p>
          FaktuFlow es una aplicacion SaaS de facturacion para autonomos y pequenos negocios. Antes de publicar,
      ...
      <LegalSection title="Objeto">
        <p>
          Este sitio permite conocer FaktuFlow, crear una cuenta, gestionar clientes, facturas, presupuestos y planes
          de uso del servicio.
        </p>
      </LegalSection>
      <LegalSection title="Propiedad intelectual">
        <p>
          La marca FaktuFlow, el diseno, textos, codigo y elementos visuales del servicio pertenecen a su titular o se
